...
class Player(pygame.sprite.Sprite):
    ...
    def shoot(self):
        ...
        if now - self.last_shot > self.shoot_deley:
            self.last_shot = now
            if self.power == 1:
...
class Mob(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image_org = random.choice(meteor_imgges)
    ...
    def update(self, *args):
        ...
        self.rect.x += self.speedx
        self.rect.y += self.speedy
        if self.rect.top > HEIGHT + 50 or self.rect.left < -125 or self.rect.right > WIDTH + 220:
...
# Load all sounds
shoot_sound = pygame.mixer.Sound(path.join(snd_dir, "Hit_12.wav"))
shield_sound = pygame.mixer.Sound(path.join(snd_dir, "Powerup33.wav"))
power_sound = pygame.mixer.Sound(path.join(snd_dir, "Powerup31.wav"))

expl_sounds = []
for snd in ['Explosion.wav', 'Explosion_2.wav', 'Explosion_3.wav']:
...
meteor_list = ["meteor.png", "meteor1.png", "meteor2.png", "meteor3.png", "meteor4.png",
               "meteor5.png", "meteor6.png", "meteor7.png", "meteor8.png", "enemyShip.png"]
for img in meteor_list:
    meteor_imgges.append(pygame.image.load(path.join(img_dir, img)).convert())
explosion_anim = {}
explosion_anim['lg'] = []
explosion_anim['sm'] = []
...
while running:
    ...
    # after drawing everything!!!!! flip and disp lay
    pygame.display.flip()
pygame.quit()
